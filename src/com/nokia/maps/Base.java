...
import com.nokia.maps.helper.ExitListener;
...
import com.nokia.maps.helper.ProgressNote;
...
public final class Base implements CommandListener {
    ...
    public static void InitialiseAuth() {
        ...
        ApplicationContext.getInstance().setAppID("SlIKl9L4lIWwQoIeKX9S");
        ApplicationContext.getInstance().setToken("mVjzRyabxcGi4_er2mJ3WA");
